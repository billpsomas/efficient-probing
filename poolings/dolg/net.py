...
def init_weights(m):
    ...
    if isinstance(m, nn.Conv2d):
        ...
        zero_init_gamma = False #FIXME: Dionysis hard-coded
...
def compute_precise_bn_stats(model, loader):
    ...
    num_iter = min(1024 // loader.batch_size, len(loader)) #FIXME: Dionysis hard-coded
...
def complexity(model):
    ...
    size = 224 #FIXME: Dionysis hard-coded
